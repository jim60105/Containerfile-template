...
|--|--|--|
| [docker-whisperX](https://github.com/jim60105/docker-whisperX) | A Dockerfile and CI workflow focus on multi-stage building and optimal cache adjustment. It efficiently builds close to ***175*** Docker images *in parallel*, each with a size of ***10G,*** on a weekly basis using the GitHub free runner. | [🔗](https://github.com/jim60105/docker-whisperX/blob/master/Dockerfile) |
...
| [bgutil-ytdlp-pot-provider-rs](https://github.com/jim60105/bgutil-ytdlp-pot-provider-rs) | Rust project compiled binary runs in scratch container. | [🔗](https://github.com/jim60105/bgutil-ytdlp-pot-provider-rs/blob/master/Containerfile) |
...
| [standalone-civitai-shortcut](https://github.com/jim60105/standalone-civitai-shortcut) | Python project containerization with uv solution and Nuitka compiled to executable.| [🔗](https://github.com/jim60105/standalone-civitai-shortcut/blob/master/Dockerfile) |
